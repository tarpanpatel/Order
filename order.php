...
// FIXED ROLE ACCESS: Staff role is now permitted along with Admin and Chef configurations
if (!isset($_SESSION["role"]) || ($_SESSION["role"] !== "Admin" && $_SESSION["role"] !== "Chef" && $_SESSION["role"] !== "Staff")) {
...
// REMOVED: Stale automatic 1-day before advance arrival Telegram notifier script logic to make background Cron operations independent
