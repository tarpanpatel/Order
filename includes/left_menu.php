...
// Isolated navigation links structure view map
?>
<div class="sidebar" id="appLeftNavigationMenu">
    ...
    <div class="desktop-sidebar-title">
        <div style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
            ...
            <button type="button" class="close-drawer-btn" onclick="event.stopPropagation(); toggleLeftMenu(false);" style="background: #f8f9fa; border: 1px solid #e2e8f0; border-radius: 50%; font-size: 1rem; cursor: pointer; font-weight: bold; color: #e53e3e; width: 28px; height: 28px; display: flex; align-items: center; justify-content: center; z-index: 10002;">✕</button>
        </div>
    </div>
