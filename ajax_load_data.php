...
if ($tab === 'overview') {
    ...
    if (!$hasRecords && $offset === 0) {
        echo '<tr><td colspan="4" style="text-align: center; color: #94a3b8; padding: 20px;">No dishes logged for this specific calendar period selection.</td></tr>';
    }
}
?>